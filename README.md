...
## Environments
- Preview: https://main--workfront--ravise5.hlx.page/
- Live: https://main--workfront--ravise5.hlx.live/
...
1. Open the `workfront` directory in your favorite IDE and start coding :)
